...
public class Main {
    ...
    public static void imprimirXMLSAT() throws java.io.IOException{
        ...
        if (conexaoAberta){
            try{
                ...
                String dadosXML = new String(Files.readAllBytes(Paths.get("C:/Users/matheus_castanha/Downloads/Projeto Java/XMLSAT.xml")));
    ...
    public static void imprimirXMLCancelamentoSAT() {
        if (conexaoAberta) {
            try {
                ...
                String dadosXML = new String(Files.readAllBytes(Paths.get("C:/Users/matheus_castanha/Downloads/Projeto Java/CANC_SAT.xml")));
    ...
    public static void abrirGavetaElgin() {
        ...
        if (conexaoAberta) {
            ImpressoraDLL.INSTANCE.AbreGavetaElgin(1, 50, 50);
        }
        else {
            System.out.println("Erro: Conexão não está aberta.");
        }
